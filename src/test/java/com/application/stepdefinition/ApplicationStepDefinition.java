...
public void i_enter_and_and_perform_the_substraction_operation(Integer int1, Integer int2) {
	ApplicationPage = ApplicationActions.getApplicationPage();
	ApplicationPage.covStrToNu(int1+"–"+int2);
}
...
public void i_enter_and_and_perform_the_multiplication_operation(Integer int1,Integer int2) {
	ApplicationPage = ApplicationActions.getApplicationPage();
	ApplicationPage.covStrToNu(int1+"×"+int2);
}
...
public void i_enter_and_and_perform_the_division_operation(Integer int1, Integer int2) {
	ApplicationPage = ApplicationActions.getApplicationPage();
	ApplicationPage.covStrToNu(int1+"/"+int2);
}
